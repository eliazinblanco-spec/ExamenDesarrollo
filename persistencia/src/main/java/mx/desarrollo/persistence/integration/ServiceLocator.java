...
import mx.desarrollo.persistence.dao.AsignacionIDDAO;
...
public class ServiceLocator {
    ...
    public static UnidadAprendizajeDAO getInstanceUnidadAprendizajeDAO() {
        EntityManager em = HibernateUtil.getEntityManager();
        return new UnidadAprendizajeDAO(em);
    }

    public static AsignacionIDDAO getInstanceAsignacionIDDAO() {
        EntityManager em = HibernateUtil.getEntityManager();
        return new AsignacionIDDAO(em);
    }
}